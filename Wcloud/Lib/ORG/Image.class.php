...
class Image {
     ...
     * @return string
     */
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $fontface='elephant.ttf', $verifyName='verify') { ##
        import('@.ORG.String');
        ...
        for ($i = 0; $i < $length; $i++) {
            ...
            imagettftext($im, 20, rand(-30,30) ,$x*$i+5, $height/1.25, $stringColor, $fontface, $randval{$i}); ##
        }
